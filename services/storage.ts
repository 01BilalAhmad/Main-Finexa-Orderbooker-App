...
const KEYS = {
  USER: 'fx_user',
  SHOPS: 'fx_shops',
  OFFLINE_QUEUE: 'fx_offline_queue',
  LAST_SYNC: 'fx_last_sync',
  PENDING_NOTIFICATIONS: 'fx_pending_notifications',
  LAST_RECOVERY_DATES: 'fx_last_recovery_dates',
  TOUR_COMPLETED: 'fx_tour_completed',
  SHOP_NOTES: 'fx_shop_notes',
  DAILY_TARGETS: 'fx_daily_targets',
  VISIT_STREAKS: 'fx_visit_streaks',
  TODAY_RECOVERY: 'fx_today_recovery',
  NOTIF_COUNTS: 'fx_notif_counts',
  NOTIF_SHOPS: 'fx_notif_shops', // track unique shop IDs for SMS/WhatsApp
  VISITED_SHOPS: 'fx_visited_shops',
  RECOVERY_SUBMITTED_SHOPS: 'fx_recovery_submitted_shops',
  OFFLINE_PHONE_UPDATES: 'fx_offline_phone_updates',
  DISTRIBUTOR_PHONE: 'fx_distributor_phone', // saved locally for offline receipt use
};
...
export const StorageService = {
  ...
  // ── Clear ALL AsyncStorage data for complete logout ──────────────────
